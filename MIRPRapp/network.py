...
class SimpleNet(nn.Module):
    def __init__(self, num_classes=4):
        ...
        self.pool3 = nn.AvgPool2d(kernel_size=3)
        ...
        self.unit18 = Unit(in_channels=256, out_channels=128, kernel_size=3)
        ...
        self.unit22 = Unit(in_channels=128, out_channels=64, kernel_size=3)
